...
function cl1() {
  alert('यह गलत उत्तर है! फिर से प्रयास करें।...');
}
 function cl2() {
     alert('आपने सही उत्तर चुना है! कृपया आगे बढ़ें।...');
...
var Canvas = function () {
    ...
    this.start = function () {
        ...
        terminal.update("सिमुलेशन बंद कर दिया गया")
    }
    ...
    this.stop = function () {
        ...
        terminal.update("सिमुलेशन शुरू हो गया")
    }
};
    ...
    if (x > 0 && y > 0) {
        if (canvas.action == operationType.DRAW_POINT) {
            ...
            if(x>255 && x<475 && y>414 && y<470) {
                ...
                //canvas.element.push();
                alert("कृपया कंटेनर फ्लूइड के अंदर डालें।...");
            }
